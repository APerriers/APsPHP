    ...
    <ul class="layui-nav fr nobg head-info">
        ...
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a href="{:url('admin/user/iframe')}" class="j-ajax" refresh="yes">{:input('cookie.aps_iframe') ? '单页布局' : '框架布局' }</a></dd>
            ...
            <li class="layui-nav-item {if condition="$kk eq 1"}layui-nav-itemed{/if}">
                ...
                <dl class="layui-nav-child">
                    {if condition="$vv['title'] eq '快捷菜单'"}
                        <dd><a class="admin-nav-item" data-id="0" href="{:input('cookie.aps_iframe') ? url('admin/index/welcome') : url('admin/index/index')}"><i class="aicon ai-shouye"></i> 后台首页</a></dd>
...
<script type="text/html" id="aps-theme-tpl">
    <ul class="aps-themes">
        {volist name=":session('aps_admin_themes')" id="vo"}
        <li data-theme="{$vo}" class="aps-theme-item-{$vo}"></li>
        {/volist}
    </ul>
</script>