...
<html>
<head>
    <title>管理控制台 -  Powered by {:config('apsphp.name')}</title>
    ...
    <style type="text/css">
        .asp-iframe{width:100%;height:100%;}
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" id="switchBody">
        <div class="layui-tab layui-tab-card" lay-filter="apsTab" lay-allowClose="true">
            <ul class="layui-tab-title">
                <li lay-id="0" class="layui-this">后台首页</li>
            </ul>
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe lay-id="0" src="{:url('index/welcome')}" width="100%" height="100%" frameborder="0" scrolling="yes" class="aps-iframe"></iframe>
                </div>
            </div>
        </div>
    </div>
